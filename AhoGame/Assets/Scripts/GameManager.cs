    ...
    public class GameManager : MonoBehaviour
    {
        ...
        public void GotoResult(int score){
            ...
            if (ScoreManager.CanExtra()){
				...
				for (int j = 0; j < 9 - s.targetName.Length; j++) {
					TargetName += "　";
				} 
				t.text = TargetName + " " + s.ResultPercent + "% /" + s.percent + "%  " + ScoreManager.Scores[10] + "点";
            ...
            for (int i = 0; i < 10; i++) {
                ...
                if (i < 10){
                    ...
                    t.text = TargetName + "　" + s.ResultPercent + "% /" + s.percent + "%  " + ScoreManager.Scores[i] + "点";
